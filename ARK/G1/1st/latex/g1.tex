...
\thispagestyle{plain}
\section*{What works}
Det vi ikke kunne få til at virke, var \texttt{OPCODE}, \texttt{LW} og \texttt{SW}, hvor vi endte med en segmentation fault
\section*{Testing}
I mappen \emph{asm}, kan vores test filer findes. Før man kan teste, skal man køre kommandoan "make -C asm". Herefter kan man køre de forskellige tests ved at skrive "./sim test.cfg asm/\emph{ønskede-fil}"
