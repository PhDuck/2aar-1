...
<<<<<<< HEAD
%HUSK: && and og || or begge virker og ! not
%HUSK: Test laves for: Not, And, Or, Times, Divide
%husk test:
=======
%HUSK: && and og || or begge virker
%HUSK: Test laves for: Not, And, Or, Times, Divide, error_iota, simple_iota
>>>>>>> master
