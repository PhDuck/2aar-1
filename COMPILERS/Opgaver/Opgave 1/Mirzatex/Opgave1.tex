...
Ud fra dette, så vil call-by-value være 3 og 1, da

Call-by-reference, vil være 13

Hvor call-by-value-result ender med at være 4, 2, eller 7, da det
...
\begin{description}
  ...
  \item[Dynamic scoping] Hvor det der i mod, er ligegyldigt hvilke globale værdier der er givet, så gælder de værdier inden for den respektive blok i den dynamiske del.
\end{description}

Derfor, vil det for static scoping være at $f(3)=4$ og $f(5)=4$, hvor det for static scoping vil være $f(3)=4$, da vores g funktion printer x, som er 4. Hvis vi kalder $f(5)$ får man en fejl, da y ikke er defineret
