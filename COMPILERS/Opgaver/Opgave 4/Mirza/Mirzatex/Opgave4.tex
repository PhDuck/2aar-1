...
\newcommand{\hmwkDueDate}{Sunday,\ January\ 3,\ 2016} % Due date
...
\begin{tikzpicture}
    ...
    \node[right = .1ex of 3, inner sep = 0pt, outer sep = 0pt, minimum size = 25pt] (3a) {$1$};
    \node[single world] (4) [below = 2cm of 3] {$3$};
    \node[single world] (5) [below = 2cm of 4] {$4,6$};
    \path[]
        (2) edge [in=180, out=230, thick] (2a)
        (2a) edge [->,in=310, out=0,thick] (2)
        (3) edge [in=70, out=55, thick] (3a)
        (3a) edge [->,in=310, out=285,thick] (3)
        ...
        (5) [->, thick] edge node [right, minimum size=0pt] {$1$} (2)
